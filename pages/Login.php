...
<div class="text-center mt-24">
      ...
      <span class="text-sm">or <a href="Register.php" class="text-blue-500"> 
   ...
   <form class="w-full max-w-xl bg-white rounded-lg shadow-md p-6"  method="post" action="../config/authenticate.php">
      <div class="flex flex-wrap -mx-3 mb-6">
         <div class="w-full md:w-full px-3 mb-6">
            <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for='student_num'>Student Number</label>
            <input class="appearance-none block w-full bg-white text-gray-900 font-medium border border-gray-400 rounded-lg py-3 px-3 leading-tight focus:outline-none" type='text' name='student_num' required>
         </div>
         <div class="w-full md:w-full px-3 mb-6">
            <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for='psw'>Password</label>
            <input class="appearance-none block w-full bg-white text-gray-900 font-medium border border-gray-400 rounded-lg py-3 px-3 leading-tight focus:outline-none" type='password' name='psw' required>
         </div>
