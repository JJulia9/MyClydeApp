    ...
    <section class="bg-gray-50 dark:bg-white">
        <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
            <div class="max-w-screen-md mb-8 lg:mb-16">
                <h2 class="mb-4 text-4xl font-extrabold text-gray-900 dark:text-grey">Designed for business teams like yours</h2>
            ...
            <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
                <div>
                    ...
                    <h3 class="mb-2 text-xl font-bold dark:text-grey">Marketing</h3>
                ...
                <div>
                    ...
                    <h3 class="mb-2 text-xl font-bold dark:text-grey">Legal</h3>
                ...
                <div>
                    ...
                    <h3 class="mb-2 text-xl font-bold dark:text-grey">Business Automation</h3>
                ...
                <div>
                    ...
                    <h3 class="mb-2 text-xl font-bold dark:text-grey">Finance</h3>
                ...
                <div>
                    ...
                    <h3 class="mb-2 text-xl font-bold dark:text-grey">Enterprise Design</h3>
                ...
                <div>
                    ...
                    <h3 class="mb-2 text-xl font-bold dark:text-grey">Operations</h3>
